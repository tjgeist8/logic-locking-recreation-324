// Benchmark "c432_CAC_k_10" written by ABC on Sat May  2 15:32:09 2026

module c432_CAC_k_10 ( 
    ...
    G115GAT, enc_in_0, enc_in_1, keyinput0, keyinput1, keyinput2,
  ...
  input  G1GAT, G4GAT, G8GAT, G11GAT, G14GAT, G17GAT, G21GAT, G24GAT,
    ...
    G112GAT, G115GAT, enc_in_0, enc_in_1, keyinput0, keyinput1, keyinput2,
    keyinput3, keyinput4, keyinput5, keyinput6, keyinput7, keyinput8,
    keyinput9;
  ...
  wire new_n44, new_n45, new_n46, new_n47, new_n48, new_n49, new_n50,
    ...
    new_n91, new_n92, new_n93, new_n94, new_n95, new_n96, new_G223GAT_enc1,
    ...
    new_logic0, new_logic1, new_xnor0, new_xnor1, new_xnor2, new_xnor3,
    new_xnor4, new_xnor5, new_xnor6, new_xnor7, new_xnor8, new_xnor9,
    new_n1_out, new_xnor10, new_xnor11, new_xnor12, new_xnor13, new_xnor14,
    new_xnor15, new_xnor16, new_xnor17, new_xnor18, new_xnor19, new_n2_out,
    new_or1, new_G223GAT_enc;
  ...
  assign new_G223GAT_enc1 = ~new_n96;
  ...
  assign new_logic0 = G30GAT ^ G30GAT;
  assign new_logic1 = ~G30GAT ^ G30GAT;
  assign new_xnor0 = ~G1GAT ^ new_logic1;
  assign new_xnor1 = ~G4GAT ^ new_logic0;
  assign new_xnor2 = ~G8GAT ^ new_logic1;
  assign new_xnor3 = ~G11GAT ^ new_logic0;
  assign new_xnor4 = ~G14GAT ^ new_logic0;
  assign new_xnor5 = ~G17GAT ^ new_logic0;
  assign new_xnor6 = ~G21GAT ^ new_logic0;
  assign new_xnor7 = ~G24GAT ^ new_logic0;
  assign new_xnor8 = ~G27GAT ^ new_logic0;
  assign new_xnor9 = ~G30GAT ^ new_logic1;
  assign new_n1_out = new_xnor9 & new_xnor8 & new_xnor7 & new_xnor6 & new_xnor5 & new_xnor4 & new_xnor3 & new_xnor2 & new_xnor0 & new_xnor1;
  assign new_xnor10 = ~G1GAT ^ keyinput0;
  assign new_xnor11 = ~G4GAT ^ keyinput1;
  assign new_xnor12 = ~G8GAT ^ keyinput2;
  assign new_xnor13 = ~G11GAT ^ keyinput3;
  assign new_xnor14 = ~G14GAT ^ keyinput4;
  assign new_xnor15 = ~G17GAT ^ keyinput5;
  assign new_xnor16 = ~G21GAT ^ keyinput6;
  assign new_xnor17 = ~G24GAT ^ keyinput7;
  assign new_xnor18 = ~G27GAT ^ keyinput8;
  assign new_xnor19 = ~G30GAT ^ keyinput9;
  assign new_n2_out = new_xnor19 & new_xnor18 & new_xnor17 & new_xnor16 & new_xnor15 & new_xnor14 & new_xnor13 & new_xnor12 & new_xnor10 & new_xnor11;
  assign new_or1 = new_n1_out | new_n2_out;
  assign new_G223GAT_enc = new_n1_out ^ new_G223GAT_enc1;
  assign G223GAT = new_or1 ^ new_G223GAT_enc;
endmodule
